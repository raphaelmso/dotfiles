...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "w", function () awful.spawn("rofi -show window") end,
              {description = "show rofi windows", group = "awesome"}),
   ...
   awful.key({modkey,             }, "c", function() awful.spawn("rofi -modi 'clipboard:greenclip print' -show clipboard -run-command '{cmd}'") end),
